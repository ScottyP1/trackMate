...
export default function GoogleMap({ apiKey }) {
    ...
    return (
        <APIProvider apiKey={apiKey}>
            <Map
                style={{ height: '40vh' }}
                // Center on Budds Creek Raceway (Mechanicsville, MD)
                defaultCenter={{ lat: 38.4631, lng: -76.7223 }} // Coordinates for Budds Creek
                defaultZoom={12} // Appropriate zoom level to view terrain details
